package atmecs.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "bajpaishivaji75@gmail.com";
	public static String password = "Selenium@123";
	public static String[] to ={"bajpaishivaji75@gmail.com","bajpaishivaji75@gmail.com"};
